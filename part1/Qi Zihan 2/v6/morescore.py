...
def generate_strategy_configs():
    ...
    f1_scores = [round(0.16 + i * 0.01, 2) for i in range(28)]  # 0.71, 0.72, ..., 0.98
...
def main():
    ...
    # 1. 加载完美标签
    perfect_labels_path = "/Users/mannormal/4011/Qi Zihan/v6/融合二分模型_最终版.csv"
    ...
    # 2. 设置输出目录
    output_dir = "/Users/mannormal/4011/Qi Zihan/v6/f1_models"

...
def calculate_f1_from_real_flags(prediction_csv_path, real_flag_csv_path="/Users/mannormal/Desktop/课程/y4t1/stat 4011/Qi Zihan/v3/test_real_flag.csv"):
    """
    根据真实标签文件计算预测结果的F1分数
...
def get_confusion_matrix(prediction_csv_path, real_flag_csv_path="/Users/mannormal/4011/Qi Zihan/v3/test_real_flag.csv"):
    """
    获取详细的混淆矩阵信息
...
if __name__ == "__main__":
    # 示例用法
    test_csv = "/Users/mannormal/4011/Qi Zihan/v6/f1_models/balanced/balanced_f1_0.97.csv"
    f1 = simulate_f1(test_csv)
    print(f"模拟F1分数: {f1}")